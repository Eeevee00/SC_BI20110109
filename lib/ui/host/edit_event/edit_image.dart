...
class EditProfileState extends State<EditProfile> {
  ...
  CollectionReference docUser = FirebaseFirestore.instance.collection('event');
  ...
  Future uploadFile(File image, Event currentUser, isProfilePicture) async {
    Reference storageReference = FirebaseStorage.instance
        .ref()
        .child('events/${currentUser.uid}/${image.hashCode}.jpg');
  ...
  Future compressimage2(var image) async {
                  ...
                  Padding(
                    ...
                    child: ListBody(
                      ...
                      children: <Widget>[
                        ListTile(
                          title: Text(
                            "About ${widget.currentUser.title}",
                            style: TextStyle(
