...
class _JobDetailHostWidgetState extends State<JobDetailHostWidget> {
  ...
  // Function to fetch details of a job from the 'job' collection
  getJobDetail() async {
    ...
    try {
      ...
      // Fetch the job document from the 'job' collection using its UID
      ...
      if (jobDoc.exists) {
        ...
        // Update the state with job details
        setState(() {
  ...
  // Function to delete a job with a confirmation dialog
  void deleteJob() {
    Alert(
      context: context,
      ...
      buttons: [
        ...
        DialogButton(
          ...
          onPressed: () async {
            ...
            // Delete the job document from the 'job' collection
