...
import 'job_list_screen_model.dart';
export 'job_list_screen_model.dart';

class JobListScreenWidget extends StatefulWidget {
  const JobListScreenWidget({Key? key}) : super(key: key);

  @override
  _JobListScreenWidgetState createState() => _JobListScreenWidgetState();
}

class _JobListScreenWidgetState extends State<JobListScreenWidget> {
