...
class _HostVerificationListWidgetState extends State<HostVerificationListWidget> {
  ...
  Future<void> getUserList() async {
    ...
    //QuerySnapshot<Map<String, dynamic>> usersSnapshot = await db.collection('/users').where('request_to_verify', isEqualTo: true).get();
    QuerySnapshot<Map<String, dynamic>> usersSnapshot = await db.collection('/users').get();
                          ...
                          children: [
                            AutoSizeText(
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(0.0, 2.0, 0.0, 0.0),
                                child: Text(
                                  user.request_to_verify == true ? "Pending" : "Not Verified",
                                  style: FlutterFlowTheme.of(context).bodySmall.override(
                                    fontFamily: 'Outfit',
