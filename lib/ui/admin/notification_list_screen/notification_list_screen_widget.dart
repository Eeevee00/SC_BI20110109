...
class _NotificationListScreenWidgetState
  ...
  getNotificationList() async {
    try {
      var data = await db.collection('/notification').get();
  ...
  getNotificationList2() async {
    ...
    notifications.clear();
    init();
    db.collection('/notification').get().then((data) {
    }).then((_) {
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => SendNotificationScreenWidget(),
                              ),
                            );
                            getNotificationList();
                          },
  ...
  child: InkWell(
    onTap: () async {
      await Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => NotificationDataDetailScreenWidget(notification: noti),
        ),
      );
      getNotificationList();
    },
