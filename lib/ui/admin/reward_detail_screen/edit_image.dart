...
class EditProfileState extends State<EditProfile> {
  ...
  CollectionReference docUser = FirebaseFirestore.instance.collection('rewards');
  ...
  Future uploadFile(File image, Reward currentUser, isProfilePicture) async {
    Reference storageReference = FirebaseStorage.instance
        .ref()
        .child('rewards/${currentUser.name}/${image.hashCode}.jpg');
